package com.smart.inventory.Controller.Auth;

import com.smart.inventory.Service.Auth.AuthService;
...
public class AuthController {
    ...
    public Result getLoginInfo(Authentication authentication) {
        ...
        return new Result(true, StatusCode.SUCCESS, "User Info and JSON Web Token", this.authService.login(authentication));
    }
